...
if 'AuthenticationPrx' not in _M_IceDrive.__dict__:
    ...
    Authentication._op_verifyUser = IcePy.Operation('verifyUser', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (((), _M_IceDrive._t_UserPrx, False, 0),), (), ((), IcePy._t_bool, False, 0), (_M_IceDrive._t_Unauthorized,))
...
if 'AuthenticationQueryResponsePrx' not in _M_IceDrive.__dict__:
    ...
    class AuthenticationQueryResponsePrx(Ice.ObjectPrx):
        ...
        def userExists(self, username, context=None):
            return _M_IceDrive.AuthenticationQueryResponse._op_userExists.invoke(self, ((username, ), context))

        def userExistsAsync(self, username, context=None):
            return _M_IceDrive.AuthenticationQueryResponse._op_userExists.invokeAsync(self, ((username, ), context))

        def begin_userExists(self, username, _response=None, _ex=None, _sent=None, context=None):
            return _M_IceDrive.AuthenticationQueryResponse._op_userExists.begin(self, ((username, ), _response, _ex, _sent, context))
    ...
    class AuthenticationQueryResponse(Ice.Object):
        ...
        def userExists(self, username, current=None):
    ...
    AuthenticationQueryResponse._op_userExists = IcePy.Operation('userExists', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (((), IcePy._t_string, False, 0),), (), None, ())
...
if 'AuthenticationQueryPrx' not in _M_IceDrive.__dict__:
    ...
    class AuthenticationQueryPrx(Ice.ObjectPrx):
        ...
        def doesUserExists(self, username, response, context=None):
            return _M_IceDrive.AuthenticationQuery._op_doesUserExists.invoke(self, ((username, response), context))

        def doesUserExistsAsync(self, username, response, context=None):
            return _M_IceDrive.AuthenticationQuery._op_doesUserExists.invokeAsync(self, ((username, response), context))

        def begin_doesUserExists(self, username, response, _response=None, _ex=None, _sent=None, context=None):
            return _M_IceDrive.AuthenticationQuery._op_doesUserExists.begin(self, ((username, response), _response, _ex, _sent, context))

        def end_doesUserExists(self, _r):
            return _M_IceDrive.AuthenticationQuery._op_doesUserExists.end(self, _r)
    ...
    class AuthenticationQuery(Ice.Object):
        ...
        def doesUserExists(self, username, response, current=None):
            raise NotImplementedError("servant method 'doesUserExists' not implemented")
    ...
    AuthenticationQuery._op_doesUserExists = IcePy.Operation('doesUserExists', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (((), IcePy._t_string, False, 0), ((), _M_IceDrive._t_AuthenticationQueryResponsePrx, False, 0)), (), None, ())
...
if 'BlobServicePrx' not in _M_IceDrive.__dict__:
    ...
    BlobService._op_upload = IcePy.Operation('upload', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (((), _M_IceDrive._t_UserPrx, False, 0), ((), _M_IceDrive._t_DataTransferPrx, False, 0)), (), ((), IcePy._t_string, False, 0), (_M_IceDrive._t_FailedToReadData, _M_IceDrive._t_TemporaryUnavailable, _M_IceDrive._t_Unauthorized))
    BlobService._op_download = IcePy.Operation('download', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (((), _M_IceDrive._t_UserPrx, False, 0), ((), IcePy._t_string, False, 0)), (), ((), _M_IceDrive._t_DataTransferPrx, False, 0), (_M_IceDrive._t_UnknownBlob, _M_IceDrive._t_TemporaryUnavailable, _M_IceDrive._t_Unauthorized))
...
if 'BlobQueryPrx' not in _M_IceDrive.__dict__:
    ...
    class BlobQueryPrx(Ice.ObjectPrx):
        ...
        def blobExists(self, blobId, response, context=None):
            return _M_IceDrive.BlobQuery._op_blobExists.invoke(self, ((blobId, response), context))

        def blobExistsAsync(self, blobId, response, context=None):
            return _M_IceDrive.BlobQuery._op_blobExists.invokeAsync(self, ((blobId, response), context))

        def begin_blobExists(self, blobId, response, _response=None, _ex=None, _sent=None, context=None):
            return _M_IceDrive.BlobQuery._op_blobExists.begin(self, ((blobId, response), _response, _ex, _sent, context))

        def end_blobExists(self, _r):
            return _M_IceDrive.BlobQuery._op_blobExists.end(self, _r)
    ...
    class BlobQuery(Ice.Object):
        ...
        def blobExists(self, blobId, response, current=None):
            raise NotImplementedError("servant method 'blobExists' not implemented")
    ...
    BlobQuery._op_blobExists = IcePy.Operation('blobExists', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (((), IcePy._t_string, False, 0), ((), _M_IceDrive._t_BlobQueryResponsePrx, False, 0)), (), None, ())
...
if 'DirectoryPrx' not in _M_IceDrive.__dict__:
    ...
    Directory._op_getParent = IcePy.Operation('getParent', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (), (), ((), _M_IceDrive._t_DirectoryPrx, False, 0), (_M_IceDrive._t_RootHasNoParent, _M_IceDrive._t_Unauthorized))
    Directory._op_getPath = IcePy.Operation('getPath', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (), (), ((), IcePy._t_string, False, 0), (_M_IceDrive._t_Unauthorized,))
    Directory._op_getChilds = IcePy.Operation('getChilds', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (), (), ((), _M_IceDrive._t_Strings, False, 0), (_M_IceDrive._t_Unauthorized,))
    Directory._op_getChild = IcePy.Operation('getChild', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (((), IcePy._t_string, False, 0),), (), ((), _M_IceDrive._t_DirectoryPrx, False, 0), (_M_IceDrive._t_ChildNotExists, _M_IceDrive._t_Unauthorized))
    Directory._op_createChild = IcePy.Operation('createChild', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (((), IcePy._t_string, False, 0),), (), ((), _M_IceDrive._t_DirectoryPrx, False, 0), (_M_IceDrive._t_ChildAlreadyExists, _M_IceDrive._t_Unauthorized))
    Directory._op_removeChild = IcePy.Operation('removeChild', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (((), IcePy._t_string, False, 0),), (), None, (_M_IceDrive._t_ChildNotExists, _M_IceDrive._t_Unauthorized))
    Directory._op_getFiles = IcePy.Operation('getFiles', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (), (), ((), _M_IceDrive._t_Strings, False, 0), (_M_IceDrive._t_Unauthorized,))
    Directory._op_getBlobId = IcePy.Operation('getBlobId', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (((), IcePy._t_string, False, 0),), (), ((), IcePy._t_string, False, 0), (_M_IceDrive._t_FileNotFound, _M_IceDrive._t_Unauthorized))
    Directory._op_linkFile = IcePy.Operation('linkFile', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (((), IcePy._t_string, False, 0), ((), IcePy._t_string, False, 0)), (), None, (_M_IceDrive._t_FileAlreadyExists, _M_IceDrive._t_Unauthorized, _M_IceDrive._t_TemporaryUnavailable))
    Directory._op_unlinkFile = IcePy.Operation('unlinkFile', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (((), IcePy._t_string, False, 0),), (), None, (_M_IceDrive._t_FileNotFound, _M_IceDrive._t_Unauthorized, _M_IceDrive._t_TemporaryUnavailable))
...
if 'DirectoryServicePrx' not in _M_IceDrive.__dict__:
    ...
    DirectoryService._op_getRoot = IcePy.Operation('getRoot', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (((), _M_IceDrive._t_UserPrx, False, 0),), (), ((), _M_IceDrive._t_DirectoryPrx, False, 0), (_M_IceDrive._t_TemporaryUnavailable, _M_IceDrive._t_Unauthorized))
